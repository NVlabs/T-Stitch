...
def main(args):
    ...
    save_image(samples, f"sample-{model_tag}-{args.cfg_scale}-{args.solver}-steps-{args.num_sampling_steps}-seed-{args.seed}.png", nrow=4, normalize=True, value_range=(-1, 1))
